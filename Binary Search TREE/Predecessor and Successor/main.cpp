...
int main()
{
    ...
    do
    {
        ...
        cout<<" 4. Search in Tree\n 5. Successor of given key\n 6. Predecessor of given key\n";
        cin>>op;
        switch(op)
        {
            case 0: exit(0);break;
            ...
            case 5: system("cls");
                    {
                        ...
                        cout<<"Value whose successor you want to find??\n";
                        cin>>val;
                        node *temp=succesor(root,val);
                        if(temp)
                            cout<<"successor of: "<<val<<"is: "<<temp->data<<"\n";
                        else
                            cout<<"Couldn't find\n";
                    }
                    break;
            case 6: system("cls");
                    {
                        ...
                        if(temp)
                            cout<<"predecessor of: "<<val<<"is: "<<temp->data<<"\n";
                        else
                            cout<<"Couldn't find\n";
                    }
                    break;
